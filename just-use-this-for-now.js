// I can't get atom's apm to work, so I'm not able to publish this package.
// If you want this functionality for now, just paste this into atom's init.js
...
(async function() {
  ...
  atom.commands.add('atom-workspace', 'yaphi:mdn', async function(e) {
    const state = {
